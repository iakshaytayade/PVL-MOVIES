...
API_ID = int(environ.get('24942826', ''))
API_HASH = environ.get('e3e2f3b65ef58634139ccd27d6b7d8cb', '')
BOT_TOKEN = environ.get('7110617748:AAESXbR6E3ri2MNqStoW4JVYb-K_L_z19d4', "")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('5338780505', '').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('-1001994102182', '').split()]
...
auth_channel = environ.get('-1002039691113')
...
# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://Admin:Admin@cluster0.yszqcak.mongodb.net/?retryWrites=true&w=majority', "")
...
GRP_LNK = environ.get('GRP_LNK', '@Movies_Empire_MoviesBOT')
SPRT_CHNL = environ.get('SPRT_CHNL', '@Movies_Empire_MoviesBOT')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/The_Tearsmith_The_First_Omen_Hd')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002072354864'))
